...
CREATE TABLE `Jadwal` (
  ...
  `nomor_induk_guru` varchar(10) DEFAULT NULL,
...
CREATE TABLE `Presensi_Mapel` (
  ...
  `waktu_presensi` date DEFAULT NULL,
...
CREATE TABLE `Siswa` (
  ...
  `provinsi` varchar(25) DEFAULT NULL,
  `kode_pos` int(11) DEFAULT NULL,
  `kelas_gabungan` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
--
ALTER TABLE `Presensi_Mapel`
  ADD CONSTRAINT `fk_presensi_jadwal` FOREIGN KEY (`id_jadwal`) REFERENCES `Jadwal` (`id_jadwal`) ON UPDATE CASCADE;
COMMIT;
